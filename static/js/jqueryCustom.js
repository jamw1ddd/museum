...
jQuery(document).ready(function(){
    jQuery(".btnRtl").on("click", function (e) {
        ...
        jQuery("head")
            ...
            ();
        jQuery(".currOnviewSlider").slick("unslick");
		...
		jQuery(".logosSlider").slick("unslick");
		...
		jQuery(".vsQuoteSlider").slick("unslick");
		...
		jQuery(".clientQuotesSliderVvi").slick("unslick");
		...
		jQuery(".clientQuotesSlider").slick("unslick");
		...
		jQuery(".instaFullFeedSlider").slick("unslick");
		...
		jQuery(".currOnviewSliderII").slick("unslick");
		...
		jQuery(".gallerySlider").slick("unslick");
		...
		jQuery(".simBoxImageSlider").slick("unslick");
		...
		jQuery(".currOnviewSliderIII").slick("unslick");
		...
		jQuery(".rpWidgetSlider").slick("unslick");
